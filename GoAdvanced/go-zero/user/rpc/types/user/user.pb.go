...
var file_user_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x3a, 0x0a,
	0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x32, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x15, 0x2e,
...
var file_user_proto_goTypes = []interface{}{
	...
	nil,                     // 2: user.UserAuthReply.ExtendEntry
}
var file_user_proto_depIdxs = []int32{
	2, // 0: user.UserAuthReply.extend:type_name -> user.UserAuthReply.ExtendEntry
	0, // 1: user.User.Auth:input_type -> user.UserAuthRequest
	1, // 2: user.User.Auth:output_type -> user.UserAuthReply
